...
public class BTCommunicator extends Thread {
    ...
    private void rotateTo(int motor, int end) {
    	...
    	//byte[] message = LCPMessage.getMotorMessage(motor, 0, 0);
        sendMessageAndState(message);
    }
    
    private void rotateToByLap(int motor, int speed, int end) {
       // byte[] message = LCPMessage.getMotorMessage(motor, -80, end);
    ...
    private void setMotorSpeedAndTurnRatioByLap(int motor, int speed, int turnRatio){
    ...
    final Handler myHandler = new Handler() {
        ...
        //        case MOTOR_A:
                ...
                case MOTOR_B_ACTION:
                    ...
                    break;
                case 999:
                //	rotateTo(MOTOR_A, myMessage.getData().getInt("value1"));
                	rotateToByLap(MOTOR_A,myMessage.getData().getInt("value1"),myMessage.getData().getInt("value2"));
                //	rotateToByLap(MOTOR_B,myMessage.getData().getInt("value1"),myMessage.getData().getInt("value2"));
                //	System.out.println("WWWWAAAAAAdfgdfgdfgdfgdfgdfgdfgdA");
                	break;
                case 998:
                	//reset(MOTOR_A);
